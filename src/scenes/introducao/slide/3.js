    ...
    return (
      <ContentBox>
        <PrimaryText>
          ...
          <EmptySpace/>
          <p>
            Mas muito  além das indicações de possibilidades de trabalho com habilidades da BNCC, que integram os textos das Questões Avaliativas, e que podem ser exploradas nos vários contextos propostos, a concepção e o desenvolvimento do curso buscou considerar as várias dimensões do aluno na perspectiva da BNCC.
          </p>
        </PrimaryText>
      </ContentBox>
    )
