  ...
  render() {
    return (
      <ContentBox>
        ...
        <PrimaryText>
          <p>
            No curso <Italic>Introdução ao Pensamento Computacional</Italic>, você trabalhou com os quatro pilares do Pensamento Computacional (<Bold>Abstração</Bold>, <Bold>Decomposição</Bold>, <Bold>Reconhecimento de Padrões</Bold> e <Bold>Algoritmos</Bold>) e foi também apresentado a aplicações desses pilares em situações práticas.
          </p>
          <EmptySpace/>
          ...
          <EmptySpace/>
          <p>
          Este curso não tem como pré-requisito conhecimentos sobre Computação e computadores, exceto os necessários para acessá-lo e acompanhá-lo nesta plataforma de ensino. Entretanto, a eventual aplicação dos conhecimentos aqui desenvolvidos sobre o tema Pensamento Computacional, pelo professor em sala de aula, poderá ser efetuada tanto de forma plugada quanto desplugada.
          </p>
        </PrimaryText>
      </ContentBox>
    )
